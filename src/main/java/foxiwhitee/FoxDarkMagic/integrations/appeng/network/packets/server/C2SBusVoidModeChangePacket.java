...
public class C2SBusVoidModeChangePacket extends BasePacket {
    private final PartFastEssentiaBus part;

    public C2SBusVoidModeChangePacket(ByteBuf data) {
        super(data);
        this.part = (PartFastEssentiaBus) PacketUtils.readPart(data);
    }

    public C2SBusVoidModeChangePacket(PartFastEssentiaBus part) {
        super();
        this.part = part;
